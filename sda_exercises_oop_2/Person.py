...
class Manager(Employee):
    def __init__(self, first_name: str, last_name: str, day_of_birth: date, salary: int = 1000):
        day_of_birth = self.check_birthsday(day_of_birth)
        super().__init__(first_name, last_name, day_of_birth, salary)

    @property
    def salary(self):
        return int(self._salary * 1.1)

    def who_i_am(self):
        return f"I'm Manager {self._first_name} {self._last_name} and I earn {self._salary}zl"
